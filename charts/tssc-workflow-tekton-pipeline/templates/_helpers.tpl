...
*/}}
{{- define "tssc-workflow-tekton-pipeline.name" -}}
...
*/}}
{{- define "tssc-workflow-tekton-pipeline.fullname" -}}
...
*/}}
{{- define "tssc-workflow-tekton-pipeline.chart" -}}
...
helm.sh/chart: {{ include "tssc-workflow-tekton-pipeline.chart" . }}
